...
Want to contribute to this project? See our [contributing guide](https://github.com/RGSS-CS/williams-rgss-website-dev-frontend/blob/release-mini/CONTRIBUTING.md)!

## License and Attribution

All code in this repository is licensed under [RGSS CS' MIT License](https://github.com/RGSS-CS/williams-rgss-website-dev-frontend/blob/release-mini/LICENSE).

This is a [Next.js](https://nextjs.org) project bootstrapped with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).

For full attribution and license for open-source software used, see our [OSS-Licenses](https://github.com/RGSS-CS/williams-rgss-website-dev-frontend/blob/release-mini/OSS-LICENSES.md).
